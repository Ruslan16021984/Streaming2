...
import kotlinx.android.synthetic.main.dialog_live.live_video_view
import kotlinx.android.synthetic.main.dialog_live.start_group
...
class LiveDialog : BaseDialog<LiveViewModel>() {
    ...
    private fun initializePlayer() {
        ...
        val loadControl = Builder().setBufferDurationsMs(
                ...
                if (cause?.message?.contains("403") == true) {
                    ...
                    when (error.errorCode) {
                        ...
                        ExoPlaybackException.TYPE_UNEXPECTED -> {
                            ...
                            Timber.tag("TAG").e("onPlayerError ---ExoPlaybackException ---${cause}")
    ...
    private fun setWatchType(type: WatchType) {
        watchType = type
    }
